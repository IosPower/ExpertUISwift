...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        // For iPhone8Plus = threeXScreen == rawvalue 3
        // For iPhone8, iPhone5 = twoXScreen == rawvalue 2
        // For iPhone4 = oneXScreen == rawvalue 1
        PixelHelper.objPixelHelper.pixelMulti  = PixelHelper.DefaultTwoXOrThreeX.threeXScreen.rawValue
